    ...
    try {
      ...
      if (fbRes.success && fbRes.email) {
        ...
        if (googleEmailRegex.test(cleanEmail)) {
          ...
          if (isAdmin) {
            const adminTok = "secret_astro_token_sampathub89_" + Date.now();
    ...
    try {
      ...
      try {
        ...
        if (saveResult && saveResult.success) {
          ...
          // If the admin is logged in, refresh list
        ...
        console.error("Auto save failed after prediction:", saveErr);
      }
              ...
              {viewingAdminPalmReport.palmImageBase64 && (
                <div className="mb-4 text-center">
                  <img
                    ...
                    alt="Uploaded Palm"
                    className="max-h-56 mx-auto rounded-lg border border-amber-500/40 shadow-lg object-contain"
                  />
                </div>
              )}
                            ...
                            <tr key={rep.id} className="hover:bg-indigo-500/5 transition-all text-left">
                              ...
                              <td className="p-3.5 text-center">
                                <div className="flex flex-col gap-1.5 w-full min-w-[110px]">
                                  {rep.reportType === 'palmistry' ? (
                                    <button
                                      onClick={() => setViewingAdminPalmReport(rep)}
